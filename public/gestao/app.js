(() => {
  ...
  async function loadProfileAndApp(){
    ...
    profile=data;$('#userName').textContent=profile.nome||session.user.email;$('#userRole').textContent=profile.role==='admin'?'Administrador':'Caixa';
