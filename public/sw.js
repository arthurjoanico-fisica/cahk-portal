const CACHE='cahk-v6.0.7-shell';
const CORE=['/','/portal-v5.css?v=6.0.7','/portal-v5.js?v=6.0.7','/assets/cahk-logo-v32.png','/assets/favicon-192.png','/biblioteca/','/projetos/','/vida-campus/','/agenda/','/transparencia/','/instalar/','/install-app.css','/pwa.js?v=6.0.7'];
